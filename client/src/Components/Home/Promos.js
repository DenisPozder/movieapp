    ...
    <div className='my-20 py-20 md:px-20 px-8 bg-dry'>
      <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
        <div className='flex lg-gap-10 gap-6 flex-col'>
          <h1 className='hl:text-3xl text-xl capitalize font-sans font-medium xl:leading-relaxed'>
          ...
          <div className='flex gap-4 md:text-lg text-sm'>
            ...
            <div className='flex-rows gap-4 bg-black text-subMain px-6 py-3 rounded font-bold'><FiUser /> 2K</div>
          </div>
        </div>
        <div>
