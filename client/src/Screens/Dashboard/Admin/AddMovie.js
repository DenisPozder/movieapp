...
function AddMovie() {
    ...
    useEffect(() => {
        ...
        if(isSuccess){
            reset({name: "", time: 0, language: "", year: 0, category: "", desc: ""})
            setImageTitle("")
  ...
  return (
    <SideBar>
        ...
        <div className='flex flex-col gap-6'>
            <h2 className='text-sl font-bold'>Create Movie</h2>
            ...
            {/* SUBMIT */}
                <button disabled={isLoading} onClick={handleSubmit(onSubmit)} className='bg-subMain w-full flex-rows gap-6 font-medium text-white py-4 rounded'>
                    {
