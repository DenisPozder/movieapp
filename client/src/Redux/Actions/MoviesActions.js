...
export const reviewMovieAction = ({id, review}) => async (dispatch, getState) => {
    try {
        ...
        const response = await moviesAPIs.reviewMovieService(tokenProtetion(getState), id, review)
...
export const deleteMovieAction = (id) => async (dispatch, getState) => {
    try {
        ...
        const response = await moviesAPIs.deleteMovieService(tokenProtetion(getState), id)
...
export const deleteAllMoviesAction = () => async (dispatch, getState) => {
    try {
        ...
        const response = await moviesAPIs.deleteAllMoviesService(tokenProtetion(getState))
...
export const createMovieAction = (movie) => async (dispatch, getState) => {
    try {
        ...
        const response = await moviesAPIs.createMovieService(tokenProtetion(getState), movie)
...
export const updateMovieAction = (id, movie) => async (dispatch, getState) => {
    try {
        ...
        const response = await moviesAPIs.updateMovieService(
            tokenProtetion(getState), id, movie
        )
